...
Popup {
    ...
    contentItem: Item {
        Item {  // close button
            ...
            width: LKGeometry.ButtonCloseWidth; height: LKGeometry.ButtonCloseHeight
            z: 1

            LKText {
                anchors.centerIn: parent
                p_color: LKPalette.ThemeLightBlue
                p_size: 12
                p_text: "Done"
            }
    ...
    enter: Transition {
        ...
        NumberAnimation {
            property: "opacity"
            duration: LKMotion.Soon
            from: 0.0; to: 1.0
        }
        NumberAnimation {
            property: "width"
            duration: LKMotion.Soft
