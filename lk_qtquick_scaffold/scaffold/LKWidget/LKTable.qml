...
ScrollView {
    ...
    property int __cellHeight: LKGeometry.BarHeight
    property int __cellWidthMax: LKGeometry.BarWidth
    property int __cellWidthMin: LKGeometry.ButtonWidthM
    ...
    Row {  // horizontal linear constraint
        ...
        Repeater {
            ...
            delegate: ListView {
                id: _list
                objectName: "LKTable.qml#_list" + p_colx
                ...
                header: LKRectangle {
                    ...
                    Item {
                        ...
                        MouseArea {
                            ...
                            onMouseXChanged: {
                                if (drag.active) {
                                    // console.log("LKTable.qml:116", mouseX, parent.x)
                ...
                // Component.onCompleted: {
                //     console.log("LKTable.qml:78", p_colx, _list.model,
        ...
        Component {
            ...
            LKRectangle {
                ...
                Component.onCompleted: {
                    // console.log("LKTable.qml:112", parent, parent.parent)
                    // //                             ^ QQuickItem (don't know who it is)
                    // //                                     ^ this is ListView

                    let preferredWidth = _txt.width + LKGeometry.HSpacingM * 2
